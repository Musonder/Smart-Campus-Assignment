...
from shared.events.base import Event, DomainEvent
...
class EventStream:
    ...
    def __init__(self, stream_id: str):
        ...
        self._max_history: Optional[int] = None  # None = unlimited
    ...
    def set_max_history(self, max_events: Optional[int]) -> None:
        """
