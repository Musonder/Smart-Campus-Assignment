...
3. GitHub/GitLab will automatically render them
...
### For Presentations
1. Export diagrams as PNG/SVG from Mermaid Live
2. Include in PowerPoint/Keynote
3. Or use Mermaid in reveal.js presentations
...
1. Update the corresponding Mermaid code
