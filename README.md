...
This repository implements the **“Argos: A Federated, Adaptive Smart Campus Orchestration Platform”** assignment using Python microservices, a React + TypeScript frontend, ML‑assisted analytics, event sourcing, and a Raft‑based consensus service.

👉 **Start here:** read [`README_FIRST.md`](./README_FIRST.md). It is the **primary guide** and explains:
...
- `FRONTEND_FEATURES.md` / `IMPLEMENTATION_SUMMARY.md` – detailed frontend features and implementation notes.
- `SYSTEM_STATUS.md` – current feature matrix and verification checklist.

If you only read one document: **open `README_FIRST.md`**. It links to everything else you need.
